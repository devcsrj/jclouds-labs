...
public abstract class Nic {
   ...
   public static Nic create(String requestId, String id, String name, String dataCenterId, String dataCenterVersion,
	   int lanId, boolean internetAccess, String serverId,
   ...
   public static class Builder {
	 ...
	 return this;
      ...
      public Nic build() {
	 return Nic.create(requestId, id, name, dataCenterId, dataCenterVersion, lanId, internetAccess, serverId, ips,
		 macAddress, firewalls, dhcpActive, gatewayIp, state);
      }
	 ...
	 return this.id(in.id()).name(in.name()).dataCenterId(in.dataCenterId()).dataCenterVersion(in.dataCenterVersion())
		 ...
		 .ips(in.ips()).macAddress(in.macAddress()).dhcpActive(in.dhcpActive()).gatewayIp(in.gatewayIp())
