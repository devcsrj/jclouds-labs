...
public class CreateDataCenterResponseHandler extends BaseDataCenterResponseHandler<DataCenter> {

   private boolean done = false;

   @Inject
   public CreateDataCenterResponseHandler(DateCodecFactory dateCodec) {
      super(dateCodec);
   }
