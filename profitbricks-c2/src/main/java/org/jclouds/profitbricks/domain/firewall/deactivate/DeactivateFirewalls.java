 ...
 */
package org.jclouds.profitbricks.domain.firewall.deactivate;
...
/**
 * <p>
 * Java class for deactivateFirewalls complex type.
 *
 * <p>
 * The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="deactivateFirewalls">
 *   &lt;complexContent>
...
@XmlType(name = "deactivateFirewalls", propOrder = {
   "firewallIds"
})
public class DeactivateFirewalls {

   protected List<String> firewallIds;

   public DeactivateFirewalls() {
      this.firewallIds = Lists.newArrayList();
   }

   public DeactivateFirewalls(List<String> firewallIds) {
