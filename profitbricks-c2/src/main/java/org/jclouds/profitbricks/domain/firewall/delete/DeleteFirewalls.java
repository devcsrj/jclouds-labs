 ...
 */
package org.jclouds.profitbricks.domain.firewall.delete;
...
/**
 * <p>
 * Java class for deleteFirewalls complex type.
 *
 * <p>
 * The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="deleteFirewalls">
 *   &lt;complexContent>
...
@XmlType(name = "deleteFirewalls", propOrder = {
   "firewallIds"
})
public class DeleteFirewalls {

   protected List<String> firewallIds;

   public DeleteFirewalls() {
      this.firewallIds = Lists.newArrayList();
   }

   public DeleteFirewalls(List<String> firewallIds) {
