...
@XmlType(name = "registerServersOnLoadBalancer", propOrder = {
   "serverIds",
   "loadBalancerId"
})
public class RegisterServersOnLoadBalancer {

   protected List<String> serverIds;
   protected String loadBalancerId;

   public RegisterServersOnLoadBalancer() {
      this.serverIds = Lists.newArrayList();
   }

   public RegisterServersOnLoadBalancer(List<String> serverIds, String loadBalancerId) {
