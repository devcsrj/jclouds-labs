...
public class UpdateStorageRequestBinder extends CreateStorageRequestBinder {
   ...
   public <R extends HttpRequest> R bindToRequest(R request, Map<String, Object> postParams) {
      ...
      UpdateStorageRequest storage = UpdateStorageRequest.class.cast(storageObj);

      return createRequest(request, generateRequestPayload(storage));
   }

   private String generateRequestPayload(UpdateStorageRequest storage) {
      requestBuilder.append("<ws:updateStorage>")
              .append("<request>")
              ...
              .append(ifNotEmpty("<size>%d</size>", storage.getSize()))
