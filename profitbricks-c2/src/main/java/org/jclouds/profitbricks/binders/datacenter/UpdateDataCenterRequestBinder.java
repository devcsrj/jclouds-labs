...
public class UpdateDataCenterRequestBinder extends BaseProfitBricksRequestBinder {
   ...
   public <R extends HttpRequest> R bindToRequest(R request, Map<String, Object> postParams) {
      ...
      UpdateDcRequest vdc = UpdateDcRequest.class.cast(vdcObj);

      return createRequest(request, generateRequestPayload(vdc));
   }

   private String generateRequestPayload(UpdateDcRequest vdc) {
      requestBuilder.append("<ws:updateDataCenter>")
              .append("<request>")
              .append(format("<dataCenterId>%s</dataCenterId>", vdc.getDataCenterId()))
              .append(ifNotEmpty("<dataCenterName>%s</dataCenterName>", vdc.getDataCenterName()))
              .append("</request>")
