...
import org.jclouds.profitbricks.handlers.ResponseStatusFromPayloadHttpCommandExecutorService;
...
/**
 * Configures the {@link org.jclouds.profitbricks.ProfitBricksApi} connection.
 */
@ConfiguresHttpApi
public class PBHttpApiModule extends HttpApiModule<ProfitBricksApi> {
   ...
   public static class PBHttpCommandExecutorServiceModule extends AbstractModule {
